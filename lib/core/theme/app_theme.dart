...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle: lightTextTheme(ThemeData.light().textTheme)
          .displayMedium
          ?.copyWith(color: AppColors.lightOnPrimaryColor, fontSize: 20),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle:
          darkTextTheme(ThemeData.dark().textTheme).titleLarge?.copyWith(
