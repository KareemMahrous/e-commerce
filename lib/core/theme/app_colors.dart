...
abstract class AppColors {
  ...
  static final grayShade100 = Colors.grey.shade100;
  static final grayShade200 = Colors.grey.shade200;
  static final grayShade300 = Colors.grey.shade300;
  static const transparent = Colors.transparent;
  static const blueColor = Color(0xff03758E);
  static const primary = Colors.greenAccent; //AppColors.greenColor;
  static const blue = Color(0xFF2156A3);
  ...
  static const Color blueGrey = Color(0xFF858A8F);
  ...
  static const Color lightSecondaryColor = Color(0xFF131D26);
  static const Color lightSecondaryVariantColor = Color(0xFF018786);
  static const Color lightSurfaceColor = Color(0xFFFFFFFF);
  static const Color lightErrorColor = Color(0xFFB00020);
  static const Color lightOnPrimaryColor = Color(0xFF000000);
  static const Color lightOnSecondaryColor = Color(0xFFFFFFFF);
